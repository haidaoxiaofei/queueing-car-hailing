...
sys.path.append('/home/luban/DeepST')
...
def main():
    ...
    if os.path.exists(fname) and CACHEDATA:
        ...
        X_train, Y_train, X_test, Y_test, mmn, external_dim, timestamp_train, timestamp_test = TaxiBJ.load_data(
            ...
            preprocess_name='preprocessing.pkl', meta_data=use_meta, meteorol_data=use_meta, holiday_data=use_meta)
        if CACHEDATA:
    ...
    print('external_dim:{}'.format(external_dim))
